			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						...
						<span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="index.php?page=manage_career" id="new_career">
...
<script>
	...
	$('.edit_career').click(function(){
		...
		location.href ="index.php?page=manage_career&id="+$(this).attr('data-id')
