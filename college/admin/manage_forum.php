...
<div class="container-fluid">
	<form action="" id="manage-forum">
		...
		<div class="row form-group">
			<div class="col-md-8">
				<label class="control-label">Scholarship Title</label>
		...
		<div class="row form-group">
			<div class="col-md-8">
				...
				<input type="text" name="award" class="form-control" value="<?php echo isset($award) ? $award:'' ?>">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-8">
				<label class="control-label">Deadline</label>
				<input type="text" name="deadline" class="form-control" value="<?php echo isset($deadline) ? $deadline:'' ?>">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-8">
				<label class="control-label">Link</label>
				<input type="text" name="sc_link" class="form-control" value="<?php echo isset($sc_link) ? $sc_link:'' ?>">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-12">
